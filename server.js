...
app.set('port', process.env.PORT || 8000) // esta es la propiedad del puerto y aqui mejoramos la conexion settiando y le indicamos una variante de ambiente, esto es util para preparar
